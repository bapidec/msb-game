        ...
        for (MapObject mapObject : mapObjects) {     // iteracja po obiektach w layerze
            ...
            if(mapObject instanceof RectangleMapObject) {
                ...
                if(rectangleName.equals("player")) {
                    Body body = BodyHelperService.createBody(rectangle.getX() + rectangle.getWidth() / 2, rectangle.getY() + rectangle.getHeight() / 2, rectangle.getWidth(), rectangle.getHeight(), false, gameScreen.getWorld(), Constants.BIT_PLAYER, Constants.BIT_SPIDER);
